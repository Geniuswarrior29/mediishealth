    ...
    static void Main()
    {
        ...
        foreach (string file in files)
        {
            ...
            if (file.EndsWith("index.html") && !content.Contains("The Power of Ayurveda Section"))
            {
                ...
                content = content.Replace("https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", "https://i.pinimg.com/1200x/77/5b/4c/775b4c9b555ba7ec342f55829dbedeac.jpg");
            }
